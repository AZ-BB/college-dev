export default function InfoIcon({ className }: { className?: string }) {
    return (
        <svg className={className} width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M9 6V9.75" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M8.99585 12H9.00259" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}