...
export default function MenuDotsIcon({ className }: { className?: string }) {
    return (
        <svg className={cn('stroke-[#485057]', className)} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
