...
export default function AddCourseCard({ communityId }: AddCourseCardProps) {
    return (
        <ClassroomModal communityId={communityId}>
            <Card className="border-2 border-dashed border-gray-300 p-0 hover:border-orange-400 hover:bg-orange-50/50 transition-all cursor-pointer h-full flex items-center justify-center min-h-[300px] bg-white shadow-none">
