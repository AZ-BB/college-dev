          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
              ...
              <div className="rounded-2xl border border-gray-200 p-8">
                ...
                <Link
                  href="#"
                  className="block w-full rounded-xl bg-gray-100 py-3 text-center font-semibold text-gray-900 hover:bg-gray-200 transition mb-8"
                >
              ...
              <div className="rounded-2xl border border-gray-200 p-8">
                ...
                <h3 className="text-3xl font-bold mb-2">
                  3% Fee <span className="text-lg font-medium text-gray-600">Per Paying Member</span>
                </h3>
